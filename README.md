...
3. Adicione o remote upstream para manter seu repositório local atualizado: `git remote add upstream https://github.com/rafsn/dio-lab-open-source.git`;
...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/rafsn`;
    > Exemplo: `git checkout -b feat/community/rafsn`
...
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add rafsn profile"`;
